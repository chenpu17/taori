...
export const research_sessions = sqliteTable(
  'research_sessions',
  {
    ...
    plan_origin: text('plan_origin').notNull().default('pending'),
    ...
    synthesis_model_id: text('synthesis_model_id'),
...
export const research_claims = sqliteTable(
  'research_claims',
  {
    ...
    evidence_spans_json: text('evidence_spans_json').notNull().default('[]'),
